...
const Link: React.FC<{
  ...
  return <Typography {...props} accessibilityRole="link" />;
};
    ...
    >
      ...
      >
        <Image
          ...
          resizeMode="contain"
        />
        <Typography variant="h1">React Native for DevCon</Typography>
      </Box>
      <Box
        style={{
          width: "80%",
      ...
      >
        ...
        <Typography variant="small">
          To get started, edit
          <Link href="https://codesandbox.io/s/q4qymyp2l6/">src/App.js</Link>.
        </Typography>
      </Box>
